...
class _CartState extends State<Cart> {
  ...
  Future<bool> removeFromCart(
    ...
    var request = http.Request('DELETE', Uri.parse('https://divine-drapes.onrender.com/user/removeCart/$productId'));
                                            ...
                                            child: Container(
                                              ...
                                              child: ListTile(
                                                leading: FractionallySizedBox(
                                                  ...
                                                  child: AspectRatio(
                                                    aspectRatio: 1,
                                                    child: (cartProducts[index]!.photo.picture.isEmpty)
                                                        ? Image.asset(
                                                            'assets/Vector.png',
                                                        ...
                                                        : Image.network(
                                                            cartProducts[index]!.photo.picture[0],
                                                            fit: BoxFit.fill,
                                                          ),
                                                  ),
                                                ),
